...
export const AgentDecisionFindManySelectSchema: z.ZodType<Prisma.AgentDecisionSelect> = z.object({
...
export const AgentDecisionFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    organizationId: z.boolean().optional(),
    organization: z.boolean().optional(),
    agentType: z.boolean().optional(),
...
export const AgentDecisionFindManySchema: z.ZodType<Prisma.AgentDecisionFindManyArgs> = z.object({ select: AgentDecisionFindManySelectSchema.optional(), include: z.lazy(() => AgentDecisionIncludeObjectSchema.optional()), orderBy: z.union([AgentDecisionOrderByWithRelationInputObjectSchema, AgentDecisionOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgentDecisionWhereInputObjectSchema.optional(), cursor: AgentDecisionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgentDecisionScalarFieldEnumSchema, AgentDecisionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AgentDecisionFindManyArgs>;

export const AgentDecisionFindManyZodSchema = z.object({ select: AgentDecisionFindManySelectSchema.optional(), include: z.lazy(() => AgentDecisionIncludeObjectSchema.optional()), orderBy: z.union([AgentDecisionOrderByWithRelationInputObjectSchema, AgentDecisionOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgentDecisionWhereInputObjectSchema.optional(), cursor: AgentDecisionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgentDecisionScalarFieldEnumSchema, AgentDecisionScalarFieldEnumSchema.array()]).optional() }).strict();