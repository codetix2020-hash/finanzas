...
export const SaasMetricsFindManySelectSchema: z.ZodType<Prisma.SaasMetricsSelect> = z.object({
...
export const SaasMetricsFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    organizationId: z.boolean().optional(),
    organization: z.boolean().optional(),
    date: z.boolean().optional(),
...
export const SaasMetricsFindManySchema: z.ZodType<Prisma.SaasMetricsFindManyArgs> = z.object({ select: SaasMetricsFindManySelectSchema.optional(), include: z.lazy(() => SaasMetricsIncludeObjectSchema.optional()), orderBy: z.union([SaasMetricsOrderByWithRelationInputObjectSchema, SaasMetricsOrderByWithRelationInputObjectSchema.array()]).optional(), where: SaasMetricsWhereInputObjectSchema.optional(), cursor: SaasMetricsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SaasMetricsScalarFieldEnumSchema, SaasMetricsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.SaasMetricsFindManyArgs>;

export const SaasMetricsFindManyZodSchema = z.object({ select: SaasMetricsFindManySelectSchema.optional(), include: z.lazy(() => SaasMetricsIncludeObjectSchema.optional()), orderBy: z.union([SaasMetricsOrderByWithRelationInputObjectSchema, SaasMetricsOrderByWithRelationInputObjectSchema.array()]).optional(), where: SaasMetricsWhereInputObjectSchema.optional(), cursor: SaasMetricsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SaasMetricsScalarFieldEnumSchema, SaasMetricsScalarFieldEnumSchema.array()]).optional() }).strict();