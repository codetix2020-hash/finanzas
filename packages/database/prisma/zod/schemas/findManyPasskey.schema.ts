...
export const PasskeyFindManySelectSchema: z.ZodType<Prisma.PasskeySelect> = z.object({
...
export const PasskeyFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    publicKey: z.boolean().optional(),
    userId: z.boolean().optional(),
...
export const PasskeyFindManySchema: z.ZodType<Prisma.PasskeyFindManyArgs> = z.object({ select: PasskeyFindManySelectSchema.optional(), include: z.lazy(() => PasskeyIncludeObjectSchema.optional()), orderBy: z.union([PasskeyOrderByWithRelationInputObjectSchema, PasskeyOrderByWithRelationInputObjectSchema.array()]).optional(), where: PasskeyWhereInputObjectSchema.optional(), cursor: PasskeyWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PasskeyScalarFieldEnumSchema, PasskeyScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PasskeyFindManyArgs>;

export const PasskeyFindManyZodSchema = z.object({ select: PasskeyFindManySelectSchema.optional(), include: z.lazy(() => PasskeyIncludeObjectSchema.optional()), orderBy: z.union([PasskeyOrderByWithRelationInputObjectSchema, PasskeyOrderByWithRelationInputObjectSchema.array()]).optional(), where: PasskeyWhereInputObjectSchema.optional(), cursor: PasskeyWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PasskeyScalarFieldEnumSchema, PasskeyScalarFieldEnumSchema.array()]).optional() }).strict();