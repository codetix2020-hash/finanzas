...
export const AiChatFindFirstSelectSchema: z.ZodType<Prisma.AiChatSelect> = z.object({
...
export const AiChatFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    organizationId: z.boolean().optional(),
    organization: z.boolean().optional(),
    userId: z.boolean().optional(),
...
export const AiChatFindFirstSchema: z.ZodType<Prisma.AiChatFindFirstArgs> = z.object({ select: AiChatFindFirstSelectSchema.optional(), include: z.lazy(() => AiChatIncludeObjectSchema.optional()), orderBy: z.union([AiChatOrderByWithRelationInputObjectSchema, AiChatOrderByWithRelationInputObjectSchema.array()]).optional(), where: AiChatWhereInputObjectSchema.optional(), cursor: AiChatWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AiChatScalarFieldEnumSchema, AiChatScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AiChatFindFirstArgs>;

export const AiChatFindFirstZodSchema = z.object({ select: AiChatFindFirstSelectSchema.optional(), include: z.lazy(() => AiChatIncludeObjectSchema.optional()), orderBy: z.union([AiChatOrderByWithRelationInputObjectSchema, AiChatOrderByWithRelationInputObjectSchema.array()]).optional(), where: AiChatWhereInputObjectSchema.optional(), cursor: AiChatWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AiChatScalarFieldEnumSchema, AiChatScalarFieldEnumSchema.array()]).optional() }).strict();