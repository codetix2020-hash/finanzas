...
export const FinancialTransactionCreateNestedManyWithoutOrganizationInputObjectSchema: z.ZodType<Prisma.FinancialTransactionCreateNestedManyWithoutOrganizationInput> = makeSchema() as unknown as z.ZodType<Prisma.FinancialTransactionCreateNestedManyWithoutOrganizationInput>;
export const FinancialTransactionCreateNestedManyWithoutOrganizationInputObjectZodSchema = makeSchema();
