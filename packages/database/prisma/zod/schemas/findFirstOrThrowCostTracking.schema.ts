...
export const CostTrackingFindFirstOrThrowSelectSchema: z.ZodType<Prisma.CostTrackingSelect> = z.object({
...
export const CostTrackingFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    organizationId: z.boolean().optional(),
    organization: z.boolean().optional(),
    provider: z.boolean().optional(),
