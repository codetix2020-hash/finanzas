...
export const PurchaseFindFirstOrThrowSelectSchema: z.ZodType<Prisma.PurchaseSelect> = z.object({
...
export const PurchaseFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    organization: z.boolean().optional(),
    organizationId: z.boolean().optional(),
    user: z.boolean().optional(),
...
export const PurchaseFindFirstOrThrowSchema: z.ZodType<Prisma.PurchaseFindFirstOrThrowArgs> = z.object({ select: PurchaseFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => PurchaseIncludeObjectSchema.optional()), orderBy: z.union([PurchaseOrderByWithRelationInputObjectSchema, PurchaseOrderByWithRelationInputObjectSchema.array()]).optional(), where: PurchaseWhereInputObjectSchema.optional(), cursor: PurchaseWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PurchaseScalarFieldEnumSchema, PurchaseScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PurchaseFindFirstOrThrowArgs>;

export const PurchaseFindFirstOrThrowZodSchema = z.object({ select: PurchaseFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => PurchaseIncludeObjectSchema.optional()), orderBy: z.union([PurchaseOrderByWithRelationInputObjectSchema, PurchaseOrderByWithRelationInputObjectSchema.array()]).optional(), where: PurchaseWhereInputObjectSchema.optional(), cursor: PurchaseWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PurchaseScalarFieldEnumSchema, PurchaseScalarFieldEnumSchema.array()]).optional() }).strict();