...
export const CostTrackingFindFirstSelectSchema: z.ZodType<Prisma.CostTrackingSelect> = z.object({
...
export const CostTrackingFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    organizationId: z.boolean().optional(),
    organization: z.boolean().optional(),
    provider: z.boolean().optional(),
...
export const CostTrackingFindFirstSchema: z.ZodType<Prisma.CostTrackingFindFirstArgs> = z.object({ select: CostTrackingFindFirstSelectSchema.optional(), include: z.lazy(() => CostTrackingIncludeObjectSchema.optional()), orderBy: z.union([CostTrackingOrderByWithRelationInputObjectSchema, CostTrackingOrderByWithRelationInputObjectSchema.array()]).optional(), where: CostTrackingWhereInputObjectSchema.optional(), cursor: CostTrackingWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CostTrackingScalarFieldEnumSchema, CostTrackingScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CostTrackingFindFirstArgs>;

export const CostTrackingFindFirstZodSchema = z.object({ select: CostTrackingFindFirstSelectSchema.optional(), include: z.lazy(() => CostTrackingIncludeObjectSchema.optional()), orderBy: z.union([CostTrackingOrderByWithRelationInputObjectSchema, CostTrackingOrderByWithRelationInputObjectSchema.array()]).optional(), where: CostTrackingWhereInputObjectSchema.optional(), cursor: CostTrackingWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CostTrackingScalarFieldEnumSchema, CostTrackingScalarFieldEnumSchema.array()]).optional() }).strict();